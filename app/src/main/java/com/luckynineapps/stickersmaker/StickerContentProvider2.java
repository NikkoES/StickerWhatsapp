...
public class StickerContentProvider2 extends ContentProvider {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.dn.whatsappsticker.stickercontentprovider";
    ...
    public static Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(CONTENT_PROVIDER_AUTHORITY).appendPath(StickerContentProvider2.METADATA).build();
    ...
    int selectedStickerPackIndex = 0;
    ...
    public boolean onCreate() {
        ...
        StickerPack pack = new StickerPack("1", "DanaOS Stickers 1", "Dana", "/sdcard/tray.png", "danaoscompany@gmail.com", "danaos.com", "danaos.com", "danaos.com");
        ArrayList<Sticker> stickers = new ArrayList<>();
        Sticker sticker1 = new Sticker("/sdcard/01_Cuppy_smile.webp", Arrays.asList(new String[] {
                "☕", "☕"
        }));
        Sticker sticker2 = new Sticker("/sdcard/02_Cuppy_lol.webp", Arrays.asList(new String[] {
                "☕", "☕"
        }));
        Sticker sticker3 = new Sticker("/sdcard/03_Cuppy_rofl.webp", Arrays.asList(new String[] {
                "☕", "☕"
        }));
        ...
        MATCHER.addURI(authority, "addpack", 6);

        for (StickerPack stickerPack : getStickerPackList()) {
            //Log.e("Log", "Identifier: "+stickerPack.identifier);
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
        ...
        return ParcelFileDescriptor.open(new File("/sdcard/01_Cuppy_smile.webp"), ParcelFileDescriptor.MODE_READ_WRITE);
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        throw new UnsupportedOperationException("Not supported");
        /*Log.e("Log", "Adding new local_sticker pack...");
        String identifier = values.getAsString("identifier");
        //Log.e("Log", "Identifier: " + identifier);
        String name = values.getAsString("name");
        String publisher = values.getAsString("publisher");
        String trayImageFile = values.getAsString("tray_image_file");
        String publisherEmail = values.getAsString("publisher_email");
        String publisherWebsite = values.getAsString("publisher_website");
        String privacyPolicyURL = values.getAsString("privacy_policy");
        String licenseAgreementURL = values.getAsString("license_agreement");
        String stickersString = values.getAsString("stickers");
        ArrayList<Sticker> stickers;
        if (stickersString == null) {
            stickers = new ArrayList<>();
        } else {
            stickers = (ArrayList<Sticker>)ObjectSerializer.deserialize(stickersString);
        }
